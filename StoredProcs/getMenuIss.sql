...
GO
/****** Object:  StoredProcedure [dbo].[getMenu]    Script Date: 08/01/2016 10:13:01 ******/
SET ANSI_NULLS OFF
GO
SET QUOTED_IDENTIFIER ON
GO

IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[getMenuIss]') AND type in (N'P', N'PC'))
	DROP PROCEDURE [dbo].[getMenuIss]
GO

CREATE  PROCEDURE [dbo].[getMenuIss] (@terminalID int, @catID int, @issuerID int)
AS
BEGIN
