...
INSERT INTO [Strings]
VALUES
  ('BillPayUtilities EON' , 0)
SET @strID = SCOPE_IDENTITY()
-- select @strID as strID

SELECT @issID = Issuer_Key FROM Issuer_Format 
WHERE LTRIM(RTRIM(Issuer_Name)) LIKE 'E.ON'
and Issuer_Key in 
(   SELECT distinct Issuer_Key 
 ...
 VALUES(
      ...
      ,0 --[Prod_SelectorText]
      ,'BillPayUtilities EON' -- defprodname
