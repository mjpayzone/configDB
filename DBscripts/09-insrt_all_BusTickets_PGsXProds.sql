...
INSERT into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Arriva Midlands%') --<PGXProds_ProdGKey>
...
and App_Key in
  (select app_key from application  where  app_name like 'Arriva Midlands%'   )
-- = 141 --Arriva Midlands 
order by 2
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Arriva NorthEast%') --<PGXProds_ProdGKey>
...
and App_Key in
  (select app_key from application  where  app_name like 'Arriva NorthEast%'   )
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Arriva NW & Wales%') --<PGXProds_ProdGKey>
...
and App_Key in 
  (select app_key from application  where  app_name like 'Arriva NW &Wales%'   )
...
INSERT into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Arriva Southern Counties%') --<PGXProds_ProdGKey>
...
and App_Key in
  (select app_key from application  where  app_name like 'Arriva Southern%'   )
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Arriva Shires%') --<PGXProds_ProdGKey>
...
and App_Key in
  (select app_key from application  where  app_name like 'Arriva Shires%'   )
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Arriva Yorkshire%') --<PGXProds_ProdGKey>
...
and App_Key in 
  (select app_key from application  where  app_name like 'Arriva Yorkshire%'   )
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets North Staffs%') --<PGXProds_ProdGKey>
...
and App_Key in 
  (select app_key from application  where  app_name like 'N Staffs%'   )
--= 130 -- N Staffs SMART  
order by 2
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets Centrebus%') --<PGXProds_ProdGKey>
...
and App_Key = 
  (select app_key from application  where  app_name like 'Centrebus%' and app_type = 10   )
--= 135 --Centrebus       
order by 2
...
insert into [ProdGroupXProds]
   SELECT distinct 
    ...
    ,prod_key
    ,(select ProductGroup_ID from ProductGroups where ProductGroup_Desc like 'BusTickets nBus%') --<PGXProds_ProdGKey>
...
and App_Key =
  (select app_key from application  where  app_name like 'nBus%'   and app_type = 10  )
--= 139 -- BusTickets nBus
order by 2
